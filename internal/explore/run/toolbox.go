...
func (s *toolSession) box() explore.ToolBox {
	specs := []explore.ToolSpec{
		...
		{Name: "input_text", Description: "Type text into the focused field.", Schema: json.RawMessage(`{"type":"object","properties":{"text":{"type":"string"}},"required":["text"],"additionalProperties":false}`)},
		{Name: "erase_text", Description: "Erase characters from the focused field.", Schema: json.RawMessage(`{"type":"object","properties":{"characters":{"type":"integer"}},"additionalProperties":false}`)},
