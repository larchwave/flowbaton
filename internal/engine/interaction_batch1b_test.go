...
func swipeElementRequest(point device.Point, direction device.Direction, duration int64, appID string) device.SwipeRequest {
	return device.SwipeRequest{ElementPoint: &point, Direction: direction, DurationMillis: duration, AppIDs: []string{appID}}
}
