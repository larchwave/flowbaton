...
func TestV0ContractSetRejectsPartialArtifactDrift(t *testing.T) {
	...
	wantArtifacts := map[string]struct {
		...
		"android-jvm-declarations":      {"android-grpc", "jvm", "drivers/android/core/src/main/java/dev/nohavewho/flowbaton/driver/contract/AndroidWireContractV0.java", "contract-complete"},
		"android-g001-runtime":          {"android-grpc", "jvm-runtime", "drivers/android/core/src/main/java/dev/nohavewho/flowbaton/driver/GrpcDeviceServer.java", "partial-g001-deviceInfo-only"},
