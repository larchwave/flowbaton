...
| pgx | `github.com/jackc/pgx/v5` v5.10.0, <https://github.com/jackc/pgx>, tag `v5.10.0`, commit `7293fb11125be0373a92f716683f2d494f6fd4b0` | MIT | PostgreSQL transactions, connection pooling, schema application, durable lease fencing, identity mappings, requests, and events for the distributed DeviceSession runtime. Module sum: `h1:VhSvgU2jSli8o3AqIEOTJr7rZwAEUVo4E4XhR94Zfr0=`. `go.mod` sum: `h1:mal1tBGAFfLHvZzaYh77YS/eC6IX9OWbRV1QIIM0Jn4=`. `LICENSE` SHA-256: `467f95e074fe23079a5623ed652619682692041b8551da27e3c2ddb9659a1507`. |
...
| go-ios | `github.com/danielpaulus/go-ios` v1.2.0, <https://github.com/danielpaulus/go-ios>, tag `v1.2.0` (declares `go 1.26`) | MIT | Physical iOS device transport (usbmuxd enumeration, app install, XCUITest launch, port forward, tunnel) behind the `internal/iosdevice` boundary package. Module sum: `h1:BqMvUajo9MAR+TuoLSwTx2fMHMPa7c3MEZ2Oka6HOHw=`. `go.mod` sum: `h1:ITNBU1yXL+MfjHCxKeFVVJygJsO437cxpELC0KwP3tI=`. `LICENSE` SHA-256: `d368be6f632f8f928369c6f1923cf2f884a1ae42a5f0dd218acd96f9bcfa75b4`. |
| cenkalti/backoff | `github.com/cenkalti/backoff` v2.2.1+incompatible, <https://github.com/cenkalti/backoff> | MIT | Compiled go-ios transitive: retry backoff inside the go-ios transport. Module sum: `h1:tNowT99t7UNflLxfYYSlKYsBpXdEet03Pg2g16Swow4=`. `go.mod` sum: `h1:90ReRw6GdpyfrHakVjL/QHaoyV4aDUVVkXQJJJ3NXXM=`. `LICENSE` SHA-256: `5c0476add4c38b55d0ed5ac11b85e00c38f26e1caee20dfe3ab58190103d1fbc`. |
| grandcat/zeroconf | `github.com/grandcat/zeroconf` v1.0.0, <https://github.com/grandcat/zeroconf> | MIT | Compiled go-ios transitive: mDNS/Bonjour discovery for network devices. Module sum: `h1:uHhahLBKqwWBV6WZUDAT71044vwOTL+McW0mBJvo6kE=`. `go.mod` sum: `h1:lTKmG1zh86XyCoUeIHSA4FJMBwCJiQmGfcP2PdzytEs=`. `LICENSE` SHA-256: `200e14ba92ed9bee1273b522c0931351bfb89c41177056e5d0cafc7e91e45c0a`. |
| Masterminds/semver | `github.com/Masterminds/semver` v1.5.0, <https://github.com/Masterminds/semver> | MIT | Compiled go-ios transitive: iOS version checks for version-dependent service dispatch. Module sum: `h1:H65muMkzWKEuNDnfl9d70GUjFniHKHRbFPGBuZ3QEww=`. `go.mod` sum: `h1:MB6lktGJrhw8PrUyiEoblNEGEQ+RzHPF078ddwwvV3Y=`. `LICENSE.txt` SHA-256: `2db9097f7b3750c1c9426996d21fe443d339131fb758c2167d2d5fabe8e6cbf9`. |
| miekg/dns | `github.com/miekg/dns` v1.1.57, <https://github.com/miekg/dns> | BSD-3-Clause | Compiled zeroconf transitive: DNS message handling for mDNS discovery. Module sum: `h1:Jzi7ApEIzwEPLHWRcafCN9LZSBbqQpxjt/wpgvg7wcM=`. `go.mod` sum: `h1:uqRjCRUuEAA6qsOiJvDd+CFo/vW+y5WR6SNmHE55hZk=`. `LICENSE` SHA-256: `f200ff9bad73385db2ed81e23ee2c1fe069eb5776e17fae4ee85ad0a9e1361a5`. |
| pkcs7 | `go.mozilla.org/pkcs7` v0.9.0, <https://github.com/mozilla-services/pkcs7> | MIT | Compiled go-ios transitive: PKCS#7 parsing for device pairing and supervision certificates. Module sum: `h1:yM4/HS9dYv7ri2biPtxt8ikvB37a980dg69/pKmS+eI=`. `go.mod` sum: `h1:SNgMg+EgDFwmvSmLRTNKC5fegJjB7v23qTQ0XLGUNHk=`. `LICENSE` SHA-256: `d01c6d371866b3c7a1a7e20994d88d2ce83f22974ec6d3596a6125b44495813d`. |
| howett.net/plist | `howett.net/plist` v1.0.1, <https://github.com/DHowett/go-plist> | BSD-2-Clause (with additional attribution clauses) | Compiled go-ios transitive: Apple property-list encoding for lockdown and service messages. Module sum: `h1:37GdZ8tP09Q35o9ych3ehygcsL+HqKSwzctveSlarvM=`. `go.mod` sum: `h1:lqaXoTrLY4hg8tnEzNru53gicrbv7rrk+2xJA/7hw9g=`. `LICENSE` SHA-256: `20d9b7d9372369484ecadae229d3e3efee8029b259e11c9a1b07d2e0a3c82e39`. |
| go-pkcs12 | `software.sslmate.com/src/go-pkcs12` v0.7.0, <https://github.com/SSLMate/go-pkcs12> | BSD-3-Clause | Compiled go-ios transitive: PKCS#12 keystore handling for pairing certificates. Module sum: `h1:Db8W44cB54TWD7stUFFSWxdfpdn6fZVcDl0w3R4RVM0=`. `go.mod` sum: `h1:Qiz0EyvDRJjjxGyUQa2cCNZn/wMyzrRJ/qcDXOQazLI=`. `LICENSE` SHA-256: `05c9cf1167d0584c9192f73a550a2089547e8366114da257f51279ec6a3fc568`. |
| golang.org/x/crypto | `golang.org/x/crypto` v0.48.0, <https://pkg.go.dev/golang.org/x/crypto> | BSD-3-Clause | Compiled go-ios transitive: cryptographic primitives for device pairing and TLS session handling. Module sum: `h1:/VRzVqiRSggnhY7gNRxPauEQ5Drw9haKdM0jqfcCFts=`. `go.mod` sum: `h1:r0kV5h3qnFPlQnBSrULhlsRfryS2pmewsg+XfMgkVos=`. `LICENSE` SHA-256: `911f8f5782931320f5b8d1160a76365b83aea6447ee6c04fa6d5591467db9dad`. |
| gvisor | `gvisor.dev/gvisor` v0.0.0-20240405191320-0878b34101b5, <https://github.com/google/gvisor> | Apache-2.0 | Compiled go-ios tunnel transitive: userspace TCP/IP stack (netstack) for the no-root iOS 17+ tunnel. Module sum: `h1:DOUDfNS+CFMM46k18FRF5k/0yz5NhZYMiUQxf4xglIU=`. `go.mod` sum: `h1:NQHVAzMwvZ+Qe3ElSiHmq9RUm1MdNHpUZ52fiEqvn+0=`. `LICENSE` SHA-256: `5af94223052169198cfa2195455b7d87209d9aa0fff4705822f328b4b272facb`. |
| quic-go | `github.com/quic-go/quic-go` v0.40.1-0.20231203135336-87ef8ec48d55, <https://github.com/quic-go/quic-go> | MIT | Compiled go-ios tunnel transitive: QUIC transport for remotexpc tunnel traffic. Module sum: `h1:I4N3ZRnkZPbDN935Tg8QDf8fRpHp3bZ0U0/L42jBgNE=`. `go.mod` sum: `h1:PeN7kuVJ4xZbxSv/4OX6S1USOX8MJvydwpTx31vx60c=`. `LICENSE` SHA-256: `77d0b7b53e8abb84cf4dd3f9945a7fdf27044240d2e8023966a721a9a46fe96e`. |
| google/btree | `github.com/google/btree` v1.1.3, <https://github.com/google/btree> | Apache-2.0 | Compiled gvisor transitive: in-memory B-tree structures. Module sum: `h1:CVpQJjYgC4VbzxeGVHfvZrv1ctoYCAI8vbl07Fcxlyg=`. `go.mod` sum: `h1:qOPhT0dTNdNzV6Z/lhRX0YXUafgPLFUh+gZMl761Gm4=`. `LICENSE` SHA-256: `cfc7749b96f63bd31c3c42b5c471bf756814053e847c10f3eb003417bc523d30`. |
| pierrec/lz4 | `github.com/pierrec/lz4` v2.6.1+incompatible, <https://github.com/pierrec/lz4> | BSD-3-Clause | Compiled go-ios transitive: LZ4 decompression in the DTX instruments codec. Module sum: `h1:9UY3+iC23yxF0UfGaYrGplQ+79Rg+h/q9FV9ix19jjM=`. `go.mod` sum: `h1:pdkljMzZIN41W+lC3N2tnIh5sFi+IEE17M5jbnwPHcY=`. `LICENSE` SHA-256: `6a358d2540ca14048f02d366f23787c0a480157e58f058113f0e27168dd4e447`. |
| songgao/water | `github.com/songgao/water` v0.0.0-20200317203138-2b4b6d7c09d8, <https://github.com/songgao/water> | BSD-3-Clause | Compiled go-ios tunnel transitive: TUN interface library (kernel-mode fallback path). Module sum: `h1:TG/diQgUe0pntT/2D9tmUCz4VNwm9MfrtPr0SU2qSX8=`. `go.mod` sum: `h1:P5HUIBuIWKbyjl083/loAegFkfbFNx5i2qEP4CNbm7E=`. `LICENSE` SHA-256: `cc2fcf72a8fbf5ded025d3b0c7ae4a410e1cee3d8c3fd6f100ccb50893cd71b3`. |
| tadglines/go-pkgs | `github.com/tadglines/go-pkgs` v0.0.0-20210623144937-b983b20f54f9, <https://github.com/tadglines/go-pkgs> | Apache-2.0 | Compiled go-ios tunnel transitive: SRP key exchange for device pairing. Module sum: `h1:aeN+ghOV0b2VCmKKO3gqnDQ8mLbpABZgRR2FVYx4ouI=`. `go.mod` sum: `h1:roo6cZ/uqpwKMuvPG0YmzI5+AmUiMWfjCBZpGXqbTxE=`. `LICENSE` SHA-256: `373675ea2a780d2433be06fbf0c1bdd1cb62b82346f382426e47e48cff38a592`. |
| golang.org/x/exp | `golang.org/x/exp` v0.0.0-20240808152545-0cdaa3abc0fa, <https://pkg.go.dev/golang.org/x/exp> | BSD-3-Clause | Compiled go-ios tunnel transitive: experimental maps/slices helpers. Module sum: `h1:ELnwvuAXPNtPk1TJRuGkI9fDTwym6AYBu0qzT8AcHdI=`. `go.mod` sum: `h1:akd2r19cwCdwSwWeIdzYQGa/EZZyqcOdwWiwj5L5eKQ=`. `LICENSE` SHA-256: `911f8f5782931320f5b8d1160a76365b83aea6447ee6c04fa6d5591467db9dad`. |
| pkg/errors | `github.com/pkg/errors` v0.9.1, <https://github.com/pkg/errors> | BSD-2-Clause | Compiled go-ios testmanagerd/DTX transitive: error wrapping inside the XCUITest session codec. Module sum: `h1:FEBLx1zS214owpjy7qsBeixbURkuhQAwrK5UwLGTwt4=`. `go.mod` sum: `h1:bwawxfHBFNV+L2hUp1rHADufV3IMtnDRdf1r5NINEl0=`. `LICENSE` SHA-256: `8d427fd87bc9579ea368fde3d49f9ca22eac857f91a9dec7e3004bdfab7dee86`. |
...
`go list -deps ./internal/iosdevice` confirms go-ios and its compiled
transitives above (cenkalti/backoff, grandcat/zeroconf, Masterminds/semver,
miekg/dns, pkcs7, howett.net/plist, go-pkcs12, golang.org/x/crypto; google/uuid
is reached here too but is already listed as a langchaingo transitive) enter
through the physical-iOS boundary package, together with the tunnel-path
transitives (gvisor, quic-go, google/btree, pierrec/lz4, songgao/water,
tadglines/go-pkgs, golang.org/x/exp) and the testmanagerd runner-delivery
transitive pkg/errors. golang.org/x/time, golang.org/x/net, golang.org/x/sys,
and golang.org/x/text are reached here too but are already listed under their
earlier entry points; MVS keeps one version of each.
